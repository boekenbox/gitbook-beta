...
4. Make sure to enter your [registered ERC-20 wallet](../profile-settings/gunthy-wallet/) \("Gunthy wallet"\) and your [registered API key](../profile-settings/connect-exchange/) in Gunbot before starting the bot core for the first time.
