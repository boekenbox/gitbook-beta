...
This page describes how margin trading works with the PingPong strategy. The triggers for trades are slightly different than in the same strategy for regular trading.
